...
} from "@/utils/formSettingsJson/search/certifySetting/recoverCertify";
// table 上方按钮
import {
  operateButtons,
  materialDetailOperateButtons
} from "@/utils/formSettingsJson/operateButton/certifySetting/recoverCertify";
// table表头信息设置
import {
  tableHeader,
  detailTableHeader,
  materialDetailTableHeader
} from "@/utils/formSettingsJson/table/certifySetting/recoverCertify";
...
import {
  ...
  contentItems,
  addMaterialButton
} from "@/utils/formSettingsJson/dialog/certifySetting/recoverCertify";
// 必填验证
import recoverCertifyRule from "@/utils/formRulesJson/certifySetting/recoverCertify";
