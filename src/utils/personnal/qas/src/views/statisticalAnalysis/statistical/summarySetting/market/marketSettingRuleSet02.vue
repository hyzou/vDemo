      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="监测级别" prop="adminLevel">
            <el-select
              v-model="settingRuleDataSource.adminLevel"
              placeholder="请选择"
              class="width100"
            >
        ...
        <el-col :span="8">
          <el-form-item label="监测环节" prop="marketType">
            <el-select
              v-model="settingRuleDataSource.marketType"
              placeholder="请选择"
              class="width100"
            >
