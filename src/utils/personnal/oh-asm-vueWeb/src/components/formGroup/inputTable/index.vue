          ...
          <template slot-scope="scope">
            ...
            <template v-else>
              <el-select
                ...
                class="width100"
                auto-complete="off"
                @change="handleIptTableSelectChange(item.key)"
              >
                <el-option
...
export default {
  ...
  methods: {
    ...
    handleIptTableSelectChange(val) {
      // console.log( name, "ipttable");
      this.$emit("tableSelectChange", this.defaultSettings.linkName, val);
    },
