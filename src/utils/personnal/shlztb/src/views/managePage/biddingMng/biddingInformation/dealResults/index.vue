...
// 配置表单数据校验规则
import dialogFormRules from "@/utils/formRulesJson/dealResult/dialogRule";
...
export default {
  ...
  methods: {
    ...
    handleOperateButton(data) {
      ...
      let that = this;
      that.dialogFormSettings.dialogFormItems.formGroupValues.type = "08";
      that.dialogFormSettings.dialogFormVisible = true;
      that.dialogFormSettings.dialogType = "form";
      that.dialogFormSettings.dialogFormTitle = "新增交易结果";
    ...
    handleTableRowButton(id, type) {
      ...
      if (type == "checkflow") {
        ...
        that.dialogFormSettings.dialogFormTitle = "编辑交易结果";
        that.dialogFormSettings.dialogFormItems.formGroupList = dialogEditFormItemslist;
