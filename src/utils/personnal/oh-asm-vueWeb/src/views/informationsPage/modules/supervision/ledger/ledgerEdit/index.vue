<template>
  <div class="width100">
    ...
    <dialogForm
      ...
      @handleDialogForm="handleStandDialogForm"
      @handleRemoveFiles="handleRemoveFiles"
    />
    <!--落实进展分配-->
    <dialogForm
      v-if="distributeDialogFormSettings.dialogFormVisible"
      :dialogFormSettings="distributeDialogFormSettings"
      @handleDialogForm="handleDistributeDialogForm"
    />
  </div>
</template>
