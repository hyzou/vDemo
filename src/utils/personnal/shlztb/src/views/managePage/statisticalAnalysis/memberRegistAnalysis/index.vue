...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/memberRegistAnalysis/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/memberRegistAnalysis/searchFormItems.json";
export default {
  ...
  methods: {
    ...
    handleSearchSubmit(flag, data) {
      let filterArr = [];
      this.url = this.$global.MemberListUrl;
