        ...
        <el-col :span="formGroupSettings.fullScreen ? 24 : 20">
          ...
          >
                ...
                <el-form label-width="100px" class="scorelist-body-content">
                  ...
                  >
                    <template v-for="itemhead in formItem.headers">
                      ...
                      >
                        <el-input
                          v-if="itemhead.inputType !== 'number'"
                        ...
                        <el-input-number
                          v-else
                          size="mini"
                          class="width100 scorelist-body-content-item-inputNumber"
                          :precision="itemhead.precision"
                          :disabled="itemhead.disabled"
                          :title="domain[itemhead.key]"
                          v-model="domain[itemhead.key]"
                          :step="1"
                  ...
                  <el-form-item
                    ...
                    v-if="formItem.useType == 'add'"
                  >
                    <!-- <el-button type="warning" icon="el-icon-circle-plus-outline" circle @click="addDomain(formItem.tableItems[0], formItem.name)"></el-button> -->
                    <el-button
                      type="primary"
                      size="mini"
            ...
            >
              ...
              >
                ...
                >
                  <template slot-scope="scope">
                    ...
                    ></el-input>
                    <!-- v-else-if="
                        item.inputType == 'number' && formItem.useType == 'add'
                      " -->
                    <el-input-number
                      v-else
                      size="mini"
              ...
              <el-row v-if="formItem.useType == 'add'">
              ...
              <!-- <inputTable
                :disabled="formItem.disabled"
                :tableDefaultData="formItem"
                @getTableData="getTableData"
                v-model="formGroupSettings.formGroupValues[formItem.name]"
              ></inputTable> -->
            </el-form-item>
            <!-- item:activTableChange -->
            <el-form-item
              class="scorelist"
                ...
                <!-- <el-form label-width="100px" class="scorelist-body-content">
                  ...
                  >
                    <template v-for="(itemhead, idx) in formItem.headers">
                      ...
                      >
                        <template
                          v-if="itemhead.type && itemhead.type == 'rate'"
                        >
                          <el-rate
                            class="pt10 pb10"
                            disabled
                        ...
                        <template v-else>
                          <template v-if="itemhead.key == 'time'">
                            {{ domain[itemhead.key] | normalTime("-") }}
                          </template>
                          <template v-else>
                            {{ domain[itemhead.key] }}
                          </template>
            ...
            >
              <span
                class="updRequire"
                :class="formItem.requierstyle"
                v-if="formItem.requireSymbol"
              >
                {{ formItem.requireSymbol }}
              </span>
              <el-upload
                class="upload-demo"
                ref="fileUpd"
              ...
              >
                ...
                <!-- <el-button
                  ...
                  type="success"
                  @click="submitUpload"
                  >{{ formItem.uploadBtn }}</el-button
                > -->
                <!-- <div slot="tip" class="el-upload__tip">{{ formItem.uploadBtn }}</div> -->
              </el-upload>
            </el-form-item>
            <!-- item:group -->
            <el-form-item v-if="formItem.type == 'group'" label-width="20px">
