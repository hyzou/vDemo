...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/adConfig/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/adConfig/searchFormItems.json";
import tableOperationsBtnList from "@/utils/formSettingsJson/adConfig/operationBtns.json";
import tableHeaderOpts from "@/utils/formSettingsJson/adConfig/tableHeaderOpt.json";
import dialogEditFormItemslist from "@/utils/formSettingsJson/adConfig/dialogFormItems.json";
import dialogFormAddBtnlist from "@/utils/formSettingsJson/adConfig/dialogAddFormBtns.json";
import dialogFormEditBtnlist from "@/utils/formSettingsJson/adConfig/dialogEditFormBtns.json";
import dialogFormRules from "@/utils/formRulesJson/adConfig/dialogRule";
import dialogViewFormItems from "@/utils/formSettingsJson/adConfig/dialogViewFormItems.json";
...
export default {
  ...
  methods: {
    ...
    handleOperateButton() {
      ...
      that.dialogFormSettings.dialogFormTitle = "新增广告信息";
    ...
    handleTableItem(id) {
      ...
      that.tablelistSettings.tableDatas.map(tabledata => {
        ...
        if (tabledata.sysId == id) {
          that.dialogFormSettings.dialogFormTitle = "广告详情";
    ...
    handleTableRowButton(id, type) {
      ...
      if (type == "edit") {
        ...
        that.dialogFormSettings.dialogFormTitle = "编辑广告信息";
        that.dialogFormSettings.dialogFormItems.formGroupList = dialogEditFormItemslist;
    ...
    getDataList(query) {
      ...
      that.$http(that.$api.getBannerlist(), postdata, true).then(xhr => {
        if (xhr && xhr.rows) {
          xhr.rows.map(item => {
            let operateBtns = [
              {
