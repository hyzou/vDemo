      ...
      >
        ...
        <el-table-column v-if="defaultSettings.expand" type="expand">
          <template slot-scope="expandDataRow">
            ...
            <!-- <div
              v-for="(expandItemdata, expandIdx) in expandDataRow.row[
                defaultSettings.expandContent
              ]"
              :key="expandIdx"
            >
              <el-form label-position="left" inline class="demo-table-expand">
                ...
                >
                  <el-select
                    ...
                    :multiple="expItem.multiple"
                    :placeholder="expItem.placeHolder || '请选择'"
                    v-model="expandItemdata[expItem.value]"
                    class="width100"
                    auto-complete="off"
                    :title="expandItemdata[expItem.value + '__selectOption']"
                    @change="
                      handleIptTableSelectChange(
                        expItem.value,
                        expandIdx,
                        expandItemdata[expItem.value],
                        expandDataRow.row[defaultSettings.expandContent]
                      )
                    "
                  >
                    <el-option
                      v-for="opt in expandItemdata[
                        expItem.value + '__selectOption'
                      ]
                        ? expandItemdata[expItem.value + '__selectOption']
                        : expItem.data"
                      :key="opt.value"
                      :label="opt.label"
                      :value="opt.value"
                  ...
                  <el-input
                    ...
                    :placeholder="expItem.placeHolder || '请输入'"
                    v-model="expandItemdata[expItem.value]"
                    :title="expandItemdata[expItem.value]"
                    @change="
                      handleIptTableSelectChange(
                        expItem.value,
                        expandIdx,
                  ...
                  <el-input-number
                    ...
                    :step="expItem.step"
                    :min="
                      expandItemdata.minNumber
                        ? expandItemdata.minNumber
                        : expItem.min
                    "
                    :max="
                      expandItemdata.maxNumber
                        ? expandItemdata.maxNumber
                        : expItem.max
                    "
                    @change="
              ...
              <template v-else>
                <el-form-item label-width="0px">
                  ...
                  <el-input-number
                    ...
                    :max="scope.row.maxNumber ? scope.row.maxNumber : item.max"
                    @change="
                      handleIptTableSelectChange(
                        item.key,
                        scope.$index,
