...
} from "@/utils/formSettingsJson/search/certifySetting/requisitionCertify";
// table 上方按钮
import {
  operateButtons,
  materialDetailOperateButtons
} from "@/utils/formSettingsJson/operateButton/certifySetting/requisitionCertify";
// table表头信息设置
import {
  tableHeader,
  detailTableHeader,
  materialDetailTableHeader
} from "@/utils/formSettingsJson/table/certifySetting/requisitionCertify";
// 新建检测单
import {
  addButton,
  editButton,
  contentItems,
  addMaterialButton
} from "@/utils/formSettingsJson/dialog/certifySetting/requisitionCertify";
// 必填验证
import requisitionCertifyRule from "@/utils/formRulesJson/certifySetting/requisitionCertify";
