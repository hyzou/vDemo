  ...
  <div class="pr10 pl10 width100">
    ...
    <el-row class="mb10">
      ...
      <el-col :span="18" class="textAlignRight">
        <template v-if="$store.getters['user/userInfos'].userId == '1000'">
        ...
        <template v-else>
          <el-button size="small" type="primary" @click="handlePreviewExport"
            >预览及导出</el-button
          >
          <el-button size="small" type="primary" @click="handleSelfEvaluation"
            >开启自评</el-button
          >
          <el-button
            size="small"
...
import distributeSuperviseTableHeader from "@/utils/formSettingsJson/informationsPage/specialAssessment/distributeSuperiseTableHeader.json";
import distributeSuperiseTableHeaderScore from "@/utils/formSettingsJson/informationsPage/assessment/distributeSuperiseTableHeaderScore.json";
    ...
    return {
      ...
      tableSettings: {
        ...
        tableSettingOptions: {
          ...
          headerOptions:
            userId == "1000"
              ? distributeSuperiseTableHeaderScore
              : distributeSuperviseTableHeader,
          isShowIndex: false,
          showIndexHeader: "序号"
        }
      },
  ...
  methods: {
    ...
    setTableList() {
      ...
      list.map(item => {
        ...
        if (this.$store.getters["user/userInfos"].userId == "1000") {
          item.operateBtns.push({
            styleType: "text",
            type: "scoreCheck",
            text: "评分审核",
