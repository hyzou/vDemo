...
export default {
  ...
  methods: {
    ...
    handleOperateButton(data) {
      ...
      let that = this;
      this.dialogFormSettings.dialogFormItems.formGroupValues.type = "04";
      that.dialogFormSettings.dialogFormVisible = true;
      that.dialogFormSettings.dialogType = "form";
      that.dialogFormSettings.dialogFormTitle = "新增入市指南";
    ...
    handleTableItem(id) {
      ...
      that.tablelistSettings.tableDatas.map(tabledata => {
        if (tabledata.sysId == id) {
          that.dialogFormSettings.dialogFormTitle = "查看入市指南";
    ...
    handleTableRowButton(id, type) {
      ...
      if (type == "checkflow") {
        ...
        that.dialogFormSettings.dialogFormTitle = "编辑入市指南";
        that.dialogFormSettings.dialogFormItems.formGroupList = dialogEditFormItemslist;
