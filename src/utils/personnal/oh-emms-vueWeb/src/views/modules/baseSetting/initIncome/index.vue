...
export default {
  ...
  mounted() {
    this.contentItems.map(dialogItem => {
      ...
      if (dialogItem.name == "sourceType" || dialogItem.name == "sourceId") {
        dialogItem.hideItem = true;
      }
      if (dialogItem.name == "hideNull") {
    ...
    this.searchFormSettings.formGroupList.map(searchItem => {
      ...
      if (searchItem.name == "sourceType" || searchItem.name == "sourceDocNo") {
        searchItem.hideItem = true;
      }
    });
    ...
    this.tableSettings.tableSettingOptions.headerOptions.map(head => {
      if (head.prop == "sourceDocNo") {
        head.isHide = true;
      }
    });
