...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/tradeRecord/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/tradeRecord/searchFormItems.json";
import tableHeaderOpts from "@/utils/formSettingsJson/tradeRecord/tableHeaderOpt.json";
import dialogEditFormItemslist from "@/utils/formSettingsJson/tradeRecord/dialogFormItems.json";
import dialogViewFormItems from "@/utils/formSettingsJson/tradeRecord/dialogViewFormItems.json";
export default {
  name: "tradeRecord",
  components: {
      ...
      if (type == "edit") {
        ...
        that.$http(that.$api.deleteBidTarget(), postdata).then(xhr => {
          if (xhr.success) {
            ...
            that.getMemberAccountQueryList();
          }
        });
      }
    },
