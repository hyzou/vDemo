...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/infoCenter/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/infoCenter/searchFormItems.json";
import tableHeaderOpts from "@/utils/formSettingsJson/infoCenter/tableHeaderOpt.json";
import dialogCheckFormItemslist from "@/utils/formSettingsJson/infoCenter/dialogCheckFormItems.json";
import dialogFormCheckBtnlist from "@/utils/formSettingsJson/infoCenter/dialogCheckFormBtns.json";
import dialogViewFormItems from "@/utils/formSettingsJson/infoCenter/dialogViewFormItems.json";
export default {
  name: "infoCenter",
  components: {
  ...
  methods: {
    ...
    handleTableItem(id) {
      ...
      that.tablelistSettings.tableDatas.map(tabledata => {
        if (tabledata.msgId == id) {
          that.dialogFormSettings.dialogFormTitle = "交易结果";
