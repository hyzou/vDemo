...
export default {
  ...
  mounted() {
    if (this.$store.getters["user/userInfos"].orgType === "OFFICE") {
      this.tableSettings.tableSettingOptions.headerOptions = this.cooperateTableHeader["office"]
    } else {
      this.tableSettings.tableSettingOptions.headerOptions = this.cooperateTableHeader["other"]
    }
