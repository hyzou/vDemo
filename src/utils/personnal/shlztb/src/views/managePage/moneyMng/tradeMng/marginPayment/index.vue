...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/marginPayment/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/marginPayment/searchFormItems.json";
import tableOperationsBtnList from "@/utils/formSettingsJson/marginPayment/operationBtns.json";
import tableHeaderOpts from "@/utils/formSettingsJson/marginPayment/tableHeaderOpt.json";
import dialogEditFormItemslist from "@/utils/formSettingsJson/marginPayment/dialogFormItems.json";
import dialogFormAddBtnlist from "@/utils/formSettingsJson/marginPayment/dialogAddFormBtns.json";
import dialogViewFormItems from "@/utils/formSettingsJson/marginPayment/dialogViewFormItems.json";
import dialogFormRules from "@/utils/formRulesJson/marginPayment/dialogRule";
export default {
  name: "marginPayment",
  components: {
  ...
  methods: {
    ...
    handleTableItem(id) {
      ...
      that.tablelistSettings.tableDatas.map(tabledata => {
        if (tabledata.sysId == id) {
          that.dialogFormSettings.dialogFormTitle = "会员保证金缴纳详情";
    ...
    handleOperateButton() {
      ...
      this.dialogFormSettings.dialogFormTitle = "添加会员保证金缴纳信息";
    ...
    handleTableRowButton(id, type) {
      ...
      if (type == "edit") {
        ...
        that.dialogFormSettings.dialogFormTitle = "查看会员保证金缴纳信息";
