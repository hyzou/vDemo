...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      "/admin": {
        ...
        // target: "http://demo.onhonest.cn:3000/oh-shlztb", //demo服务器api地址
        // target: "http://192.168.21.132:8080/oh-shlztb/", //fxg服务器api地址
        target: "http://192.168.2.243:8080/oh-shlztb/", //测试服务器api地址
  ...
  publicPath:
    process.env.NODE_ENV === "production"
      ? "/oh-shlztb/socialtender/oh-production/"
      : "/"
};
