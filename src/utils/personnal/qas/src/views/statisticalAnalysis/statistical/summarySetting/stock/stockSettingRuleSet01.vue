  ...
  <div>
    ...
    >
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="产品品种" prop="productBreed" class="width100">
            <el-select
              class="width100"
        ...
        <el-col :span="8">
          <el-form-item label="计划性质" prop="nature" class="width100">
            <el-select
              class="width100"
              v-model="settingRuleDataSource.nature"
              placeholder="请选择"
            >
              <template v-for="item in natures">
                <el-option
                  :key="item.value"
                  :label="item.text"
                  :value="item.value"
...
export default {
  ...
  data() {
    return {
      settingRuleRules: {
        ...
        menuId: { required: true, message: "不得为空", trigger: "change" }
      },
  ...
  methods: {
    ...
    loadData() {
      ...
      this.$get({
        ...
        fnc: data => {
          ...
          $this.$set($this.settingRuleDataSource, "nature", dataMsg.nature);
    ...
    changeMenu(dataMsg) {
      let selectedLink =
        this.settingRuleDataSource.selectedLink || dataMsg.link;
      this.findNatures(selectedLink);
    },
    //上移
