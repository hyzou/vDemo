...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/auctionAnalysis/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/auctionAnalysis/searchFormItems.json";
export default {
  ...
  methods: {
    ...
    handleSearchSubmit(flag, data) {
      let filterArr = [];
      this.url = this.$global.ProjectRegUrl;
