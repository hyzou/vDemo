...
import {
  dispatchLeaderDialogItems,
  dispatchLeaderDialogBtns
} from "@/utils/formSettingsJson/dialog/supervision/ledger/edit/dispatchLeaderDepartment";
...
import dispatchRules from "@/utils/formRulesJson/supervision/dispatchRules";
...
const data = function(vm) {
  ...
  return {
    ...
    dispatchLeaderDialogItems: dispatchLeaderDialogItems,
    dispatchLeaderDialogBtns: dispatchLeaderDialogBtns,
    // 当前查看的方案id
    asmSchemeId: "",
    // 当前已分配的牵头部门id
    assedLeaderDepId: "",
