    ...
    process: [
      {
        ...
        tips: [
          ...
          { tip: "2.请确认仓窗处于打开状态，双速风机处于关闭状态" },
          { tip: "3.请先用柜控操作关闭双速风机，切换至程控模式" },
          { tip: "4.点击【开始测试】启动测试" }
        ],
        tankTips: [
          { tip: "1.请确认当前设备处于对应的工艺当中" },
      ...
      },
      {
        ...
        tips: [
          { tip: "1.请确认仓窗处于打开状态" },
          { tip: "2.请点击【高速运行】按钮提高风速" },
          { tip: "3.风机正常运行后，请点击【下一动作】进行下一步测试" },
          { tip: "4.点击【终止测试】退出测试" }
        ],
        tankTips: [
          { tip: "1.请确认仓窗处于打开状态" },
