...
export default {
  ...
  mounted() {
    if (this.$store.getters["user/userInfos"].orgType === "OFFICE") {
      this.tableSettings.tableSettingOptions.headerOptions = this.selfTableHeader["office"]
    } else {
      this.tableSettings.tableSettingOptions.headerOptions = this.selfTableHeader["other"]
    }
