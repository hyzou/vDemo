...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/clientIntroduce/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/clientIntroduce/searchFormItems.json";
import tableOperationsBtnList from "@/utils/formSettingsJson/clientIntroduce/operationBtns.json";
import tableHeaderOpts from "@/utils/formSettingsJson/clientIntroduce/tableHeaderOpt.json";
import dialogEditFormItemslist from "@/utils/formSettingsJson/clientIntroduce/dialogFormItems.json";
import dialogCheckFormItemslist from "@/utils/formSettingsJson/clientIntroduce/dialogCheckFormItems.json";
import dialogFormAddBtnlist from "@/utils/formSettingsJson/clientIntroduce/dialogAddFormBtns.json";
import dialogFormEditBtnlist from "@/utils/formSettingsJson/clientIntroduce/dialogEditFormBtns.json";
import dialogFormRules from "@/utils/formRulesJson/clientIntroduce/dialogRule";
import dialogViewFormItems from "@/utils/formSettingsJson/clientIntroduce/dialogViewFormItems.json";
export default {
  name: "clientIntroduce",
  components: {
  ...
  methods: {
    ...
    handleOperateButton() {
      ...
      this.dialogFormSettings.dialogFormTitle = "新增优质供应商介绍";
    ...
    handleTableItem(id) {
      ...
      that.tablelistSettings.tableDatas.map(tabledata => {
        ...
        if (tabledata.sysId == id) {
          that.dialogFormSettings.dialogFormTitle = "供应商详情";
    ...
    handleTableRowButton(id, type) {
      ...
      if (type == "checkflow") {
        ...
        that.dialogFormSettings.dialogFormTitle = "编辑优质供应商介绍";
