<template>
  <div class="plan_from">
    <el-form label-width="100px" :model="planFormTask" ref="planFormTaskForm">
      <el-row>
        <el-col :span="21">
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="是否完成:">
              <el-select v-model="planFormTask.flag" clearable class="width100">
                <el-option
                  v-for="item in flags"
                  :key="item.value"
                  :label="item.label"
...
export default {
  ...
  data() {
    return {
      ...
      samplingTaskId: 0,
      maxHeight: "350px",
      planType: this.$constants.LINK_MARKET
    };
  },
  components: {
    sampler: sampler,
