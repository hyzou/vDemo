// 表格的头部
import { tableHeaderSettings } from "@/utils/formSettingsJson/table/randomDistrictMng/tableSettings.js";
// 对话框配置
import {
  addRandomItemDialogBtns,
  addRandomItemDialogItems
} from "@/utils/formSettingsJson/dialog/randomDistrictMng/add/dialogSettings.js";
import {
  updateRandomItemDialogBtns,
  updateRandomItemDialogItems
} from "@/utils/formSettingsJson/dialog/randomDistrictMng/update/dialogSettings.js";
import {
  checkRandomItemDialogBtns,
  checkRandomItemDialogItems
} from "@/utils/formSettingsJson/dialog/randomDistrictMng/check/dialogSettings.js";
// 搜索栏
import {
  searchFormBtns,
  searchFormItems
} from "@/utils/formSettingsJson/search/randomDistrictMng/searchSettings.js";
// 按钮组
import { operateBtns } from "@/utils/formSettingsJson/operateButton/randomDistrictMng/buttonSettings.js";
// 校验规则
import dialogSetRule from "@/utils/formRulesJson/dbRandomCheck/randomDistrictMng/dialog";
