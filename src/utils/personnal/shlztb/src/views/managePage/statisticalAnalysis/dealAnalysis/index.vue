...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/dealAnalysis/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/dealAnalysis/searchFormItems.json";
export default {
  name: "dealAnalysis",
  components: {
  ...
  methods: {
    ...
    handleSearchSubmit(flag, data) {
      let filterArr = [];
      this.url = this.$global.BidWinUrl;
