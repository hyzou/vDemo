...
// 配置数据引入
import searchFormBtnList from "@/utils/formSettingsJson/accountFundAdjustment/searchFormBtns.json";
import searchFormItemslist from "@/utils/formSettingsJson/accountFundAdjustment/searchFormItems.json";
import tableOperationsBtnList from "@/utils/formSettingsJson/accountFundAdjustment/operationBtns.json";
import tableHeaderOpts from "@/utils/formSettingsJson/accountFundAdjustment/tableHeaderOpt.json";
import dialogEditFormItemslist from "@/utils/formSettingsJson/accountFundAdjustment/dialogFormItems.json";
import dialogFormAddBtnlist from "@/utils/formSettingsJson/accountFundAdjustment/dialogAddFormBtns.json";
import dialogViewFormItems from "@/utils/formSettingsJson/accountFundAdjustment/dialogViewFormItems.json";
import dialogFormRules from "@/utils/formRulesJson/accountFundAdjustment/dialogRule";
export default {
  name: "accountFundAdjustment",
  components: {
  ...
  methods: {
    ...
    handleOperateButton() {
      ...
      this.dialogFormSettings.dialogFormTitle = "新建账户资金调整信息";
    ...
    handleTableItem(id) {
      ...
      that.tablelistSettings.tableDatas.map(tabledata => {
        if (tabledata.sysId == id) {
          that.dialogFormSettings.dialogFormTitle = "账户资金调整信息详情";
    ...
    handleTableRowButton(id, type) {
      ...
      if (type == "edit") {
        ...
        that.dialogFormSettings.dialogFormTitle = "查看账户资金调整信息";
