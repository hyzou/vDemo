...
import supervisionApi from "./apiModules/supervision";
import infosManageApi from "./apiModules/infosManage";
import assessmentApi from "./apiModules/assessment";
import schemeApi from "./apiModules/scheme";
import randomCheckItems from "./apiModules/randomCheckItems";
import randomSupervisionCheck from "./apiModules/randomSupervisionCheck";
import randomProfessorMng from "./apiModules/randomProfessorMng";
import randomDistrictMng from "./apiModules/randomDistrictMng";
import randomReports from "./apiModules/randomReports";
import poolAnalysis from "./apiModules/poolAnalysis";
...
const apiInterface = {
  ...
  // 获取类目树
  getAllKpiIndexTree: "_data/base/kpiIndex/tree",
  // 获取kpi类目树
  ...
  // 获取单条 数据项
  getSingleDataSet: "_data/base/kpiIndex/vars",
  // 获取用户里面的城市
  ...
  // 删除
  deleteOrg: "_data/asm/rbac/organization/delete",
  // 行政区划
  ...
  // 重复验证
  userRepeatCheck: "_data/base/operator/isUnique",
  /**
   * 基础数据 菜单管理
   */
  // 获取菜单
   ...
   * 基础数据 清除缓存
   */
  getCacheList: "_data/frame/cache/list",
  refreshCache: "_data/frame/cache/refresh",
  /**
   * 登录验证
   */
  ...userApi,
